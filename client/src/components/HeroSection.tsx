      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-2" data-testid="text-stat-content">10,000+</div>
            <div className="text-sm text-muted-foreground">Yaratilgan kontent</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-2" data-testid="text-stat-users">500+</div>
            <div className="text-sm text-muted-foreground">Faol foydalanuvchilar</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-2" data-testid="text-stat-saved">95%</div>
            <div className="text-sm text-muted-foreground">Vaqt tejash</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-2" data-testid="text-stat-channels">2</div>
            <div className="text-sm text-muted-foreground">Kanal integratsiyasi</div>
          </div>
        </div>
      </div>
    </section>
